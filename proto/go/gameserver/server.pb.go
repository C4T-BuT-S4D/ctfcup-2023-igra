...
func (*Inventory_Item) Descriptor() ([]byte, []int) {
	return file_gameserver_server_proto_rawDescGZIP(), []int{6, 0}
}
...
var file_gameserver_server_proto_rawDesc = []byte{
	...
	0x08, 0x63, 0x68, 0x65, 0x63, 0x6b, 0x73, 0x75, 0x6d, 0x22, 0x0d, 0x0a, 0x0b, 0x53, 0x65, 0x72,
	0x76, 0x65, 0x72, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x22, 0x12, 0x0a, 0x10, 0x49, 0x6e, 0x76, 0x65,
	0x6e, 0x74, 0x6f, 0x72, 0x79, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x22, 0x77, 0x0a, 0x09,
	0x49, 0x6e, 0x76, 0x65, 0x6e, 0x74, 0x6f, 0x72, 0x79, 0x12, 0x30, 0x0a, 0x05, 0x69, 0x74, 0x65,
	0x6d, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x1a, 0x2e, 0x67, 0x61, 0x6d, 0x65, 0x73,
	0x65, 0x72, 0x76, 0x65, 0x72, 0x2e, 0x49, 0x6e, 0x76, 0x65, 0x6e, 0x74, 0x6f, 0x72, 0x79, 0x2e,
	0x49, 0x74, 0x65, 0x6d, 0x52, 0x05, 0x69, 0x74, 0x65, 0x6d, 0x73, 0x1a, 0x38, 0x0a, 0x04, 0x49,
	...
	0x72, 0x74, 0x61, 0x6e, 0x74, 0x22, 0x48, 0x0a, 0x11, 0x49, 0x6e, 0x76, 0x65, 0x6e, 0x74, 0x6f,
	0x72, 0x79, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x33, 0x0a, 0x09, 0x69, 0x6e,
	0x76, 0x65, 0x6e, 0x74, 0x6f, 0x72, 0x79, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x15, 0x2e,
...
var file_gameserver_server_proto_msgTypes = make([]protoimpl.MessageInfo, 10)
var file_gameserver_server_proto_goTypes = []interface{}{
	...
	(*InventoryRequest)(nil),        // 5: gameserver.InventoryRequest
	(*Inventory)(nil),               // 6: gameserver.Inventory
	(*InventoryResponse)(nil),       // 7: gameserver.InventoryResponse
	(*ClientEvent_KeysPressed)(nil), // 8: gameserver.ClientEvent.KeysPressed
	(*Inventory_Item)(nil),          // 9: gameserver.Inventory.Item
}
var file_gameserver_server_proto_depIdxs = []int32{
	8, // 0: gameserver.ClientEvent.keys_pressed:type_name -> gameserver.ClientEvent.KeysPressed
	2, // 1: gameserver.ClientEventRequest.event:type_name -> gameserver.ClientEvent
	9, // 2: gameserver.Inventory.items:type_name -> gameserver.Inventory.Item
	6, // 3: gameserver.InventoryResponse.inventory:type_name -> gameserver.Inventory
	0, // 4: gameserver.GameServerService.Ping:input_type -> gameserver.PingRequest
	3, // 5: gameserver.GameServerService.ProcessEvent:input_type -> gameserver.ClientEventRequest
	5, // 6: gameserver.GameServerService.GetInventory:input_type -> gameserver.InventoryRequest
	1, // 7: gameserver.GameServerService.Ping:output_type -> gameserver.PingResponse
	4, // 8: gameserver.GameServerService.ProcessEvent:output_type -> gameserver.ServerEvent
	7, // 9: gameserver.GameServerService.GetInventory:output_type -> gameserver.InventoryResponse
